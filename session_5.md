...
## What is Helm
Helm is a package manager for Kubernetes. It allows up to bring all yaml-files together and in what's called a ***Chart***. A chart can have a *name*, a *description* and a *version*. 
